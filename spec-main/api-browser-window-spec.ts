    ...
    describe('"sandbox" option', () => {
      ...
      it('should set ipc event sender correctly', async () => {
        ...
        const done = Promise.all([
          emittedOnce(ipcMain, 'parent-answer'),
          emittedOnce(ipcMain, 'child-answer')
        ]);
      ...
      describe('event handling', () => {
        ...
        it('works for stop events', async () => {
          const done = Promise.all([
            emittedOnce(w, 'did-navigate'),
            emittedOnce(w, 'did-fail-load'),
            emittedOnce(w, 'did-stop-loading')
          ]);
        ...
        it('works for web contents events', async () => {
          const done = Promise.all([
            emittedOnce(w, 'did-finish-load'),
            emittedOnce(w, 'did-frame-finish-load'),
            emittedOnce(w, 'did-navigate-in-page'),
            emittedOnce(w, 'will-navigate'),
            emittedOnce(w, 'did-start-loading'),
            emittedOnce(w, 'did-stop-loading'),
            emittedOnce(w, 'did-frame-finish-load'),
            emittedOnce(w, 'dom-ready')
          ]);
